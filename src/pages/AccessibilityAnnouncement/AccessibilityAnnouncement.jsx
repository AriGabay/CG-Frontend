    ...
    <>
      ...
      <Grid className={(classes.root, classes.textContainer)}>
        ...
        <Typography variant="p">
          ...
          הקייטרינג, הוראות הגעה למעדניה, ביצוע הזמנות, יצירת קשר עם צוות
          המעדנייה ועוד. מטרתנו בהנגשת האתר היא יצירת שוויון הזדמנויות במרחב
          האינטרנטי לאנשים עם לקויות מגוונות ואנשים הנעזרים בטכנולוגיות מסייעות
          שונות בעת גלישה ברשת האינטרנט.
        </Typography>
